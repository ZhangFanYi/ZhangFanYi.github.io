...
ACTOR_CONFIG=(
    actor_rollout_ref.model.path=${hf_model_path}/Seed-OSS-36B-Base
...
# ===================================== Trainer Config =====================================
project_name='GRPO-Seed-OSS-36B-Base-BASE-GSM8K'
exp_name='GRPO-Seed-OSS-36B-Base-BASE-FSDP2-vLLM'
ngpus_per_node=8
